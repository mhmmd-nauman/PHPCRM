...
$newdate = strtotime ( '3 month' , strtotime ( date("Y-m-d") ) ) ;
$expirationDate = date ( 'Y-m' , $newdate );//$_POST["expirationDate"];
$firstName = "samrth"; //$_POST["firstName"];
$lastName = "patil"; //$_POST["lastName"];
$amount=8;
$totalOccurrences =3;
