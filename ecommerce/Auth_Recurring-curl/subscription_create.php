...
$refId = $_POST["refId"];
$name = 'Two month subscription'; //$_POST["name"];
$length = 1; //$_POST["length"];
$unit = 'months'; //$_POST["unit"];
$startDate =date("Y-m-d");// $_POST["startDate"];
$totalOccurrences =2;//$_POST["totalOccurrences"];
$trialOccurrences = 1;//$_POST["trialOccurrences"];
$trialAmount = 1; //$_POST["trialAmount"];
$cardNumber ='370000000000002'; //$_POST["cardNumber"];
$newdate = strtotime ( '2 month' , strtotime ( date("Y-m-d") ) ) ;
$newdate = date ( 'Y-m' , $newdate );

$expirationDate = $newdate;//$_POST["expirationDate"];
$firstName =  'sacnin' ;//$_POST["firstName"];
$lastName = 'desale'; //$_POST["lastName"];
