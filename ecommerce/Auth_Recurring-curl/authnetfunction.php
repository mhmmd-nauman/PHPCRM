...
function parse_return_order($content)
{
	 $refId = substring_between($content,'<transId>','</transId>');
	$resultCode = substring_between($content,'<resultCode>','</resultCode>');
	 $code = substring_between($content,'<code>','</code>');
	 $text = substring_between($content,'<text>','</text>');
	 $subscriptionId = substring_between($content,'<transactionType>','</transactionType>');
	 $status = substring_between($content,'<responseCode>','</responseCode>');
