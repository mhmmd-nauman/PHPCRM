...
class PayFlowTransaction {
 ...
 public function __construct() {
  ...
  /*  define('PAYFLOWPRO_USER','Irfanavtar');
	define('PAYFLOWPRO_PWD','MOS123456');
	define('PAYFLOWPRO_PARTNER','PayPal');
	define('PAYFLOWPRO_VENDOR','Irfanavtar');*/
   ...
   if ( $result_code == 0 ) {
    ...
    throw new InvalidCredentialsException( "Invalid API Credentials" );
     ...
     throw new FraudProtectionException ( "Your Transaction is Under Review. We will notify you via e-mail if accepted." );
      ...
      //
      throw new TransactionDataException( $response_arr['RESPMSG'] );
	  //print_r($response_arr['RESPMSG']);
