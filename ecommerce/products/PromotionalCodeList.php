...
<body>
<div id="headtitle" align="right">Promotional Codes</div>
...
?>
    <tr id="<?php echo $colors; ?>">
      ...
      <td >$<?php echo number_format($catcval['Price'],2); ?></td>
      <!--ProductCategoryAddPopup.php?Task=update&catid=<?php //echo $catcval['id']; ?>-->
      <td >
	  <div align="right">
    <a id="PromosEdit<?php echo $catcval['ID'];?>" href="PromosEdit.php?Task=update&catid=<?php echo $catcval['ID'];?>" title="Edit <?php echo $catcval['Category_Name']; ?>" class="editBtn"> 
