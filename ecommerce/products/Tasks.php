...
<script type="text/javascript">
         ...
         <?php  foreach((array)$tasks_array as $tasks_row){?>        
                $("#EditTask<?php echo $tasks_row['ID'];?>").click(function(e){
                              e.preventDefault();	
                              modalbox(this.href,this.title,550,800);
                  });	 
         <?php } ?>
...
$('#mainsearch').focus(function(){
   ...
   <a href="TasksEdit.php?Task=Add" id="AddTask" title="Add New Task"><input class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" type="button" id="Addnew" value="Add New Task"></a>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr id="<?php echo $row_class;?>">
   <td> <?php echo $tasks_row['ID'];?></td>
           <td width="200">
		  <?php echo $tasks_row['TasksTitle'];?>
                       </td>
 
    <td>  <?php echo $tasks_row['TasksDescription'];?>   </td>
    <td>&nbsp;</td>
     <td><a id="EditTask<?php echo $tasks_row['ID'];?>" href="TasksEdit.php?id=<?php echo $tasks_row['ID'];?>&Task=Update" title="<?php echo $tasks_row['TasksTitle'];?>"> <img src="../../images/icon_page_edit.png" border="0" title="Edit Details"/></a>
        <a href="TasksEdit.php?id=<?php echo $tasks_row['ID'];?>&Task=del" onclick="return confirmation();"> <img title="Delete From Database" src="../../images/icon_delete.png" border="0"/></a></td>
  </tr>
 <?php }?>
</table>
<div align="center">
