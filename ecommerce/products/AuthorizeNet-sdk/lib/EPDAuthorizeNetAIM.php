 ...
 * @subpackage AuthorizeNetAIM
 */
class EPDAuthorizeNetAIM extends AuthorizeNetRequest
{

    const LIVE_URL = 'https://secure.easypaydirectgateway.com/gateway/transact.dll';
    const SANDBOX_URL = 'https://secure.easypaydirectgateway.com/gateway/transact.dll';
    ...
    {
        return new EPDAuthorizeNetAIM_Response($response, $this->_x_post_fields['delim_char'], $this->_x_post_fields['encap_char'], $this->_custom_fields);
    }
 ...
 * @subpackage AuthorizeNetAIM
 */
class EPDAuthorizeNetAIM_Response extends AuthorizeNetResponse
{
