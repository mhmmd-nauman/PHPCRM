    ...
    <table width="100%" border="0" cellspacing="3" cellpadding="1" align="center" >
      <tr>
       ...
       <td align="left" colspan="3" id="message_sucess">
           <img src="images/accept.png"/>&nbsp;&nbsp;Edit Product Name And Commission Levels
                       <script>
     $(document).ready(function(){
     ...
     $(document).ready(function(){
      ...
      <tr><td> Pay Commissions For:</td><td><input name="Cycle" type="text" value="<?php echo $CommissionRec['CommissionName']; ?>" size="10" style="height:20px;"> &nbsp; Cycles:(0=unlimited)</td></tr>
      <tr><td>&nbsp; </td><td></td></tr>
