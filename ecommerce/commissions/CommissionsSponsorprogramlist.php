...
if($_REQUEST['Submit']=='Save' && $_REQUEST['Task']){
	...
	case"add":
		    $arrValue=array('CommissionName'=>$_REQUEST['Commission_Name'],'Description'=>$_REQUEST['Commission_Description'],'Created'=>date('Y-m-d H:i:s'),'LastEdited'=>date('Y-m-d H:i:s'),'ProgramsType'=>'Sponsor');
			$insertedId=$utilObj->insertRecord(' CommissionProgram', $arrValue);
			if($insertedId)
			 $Flag='added';
		 break;
	case"update":
               $arrValue=array('CommissionName'=>$_REQUEST['Commission_Name'],'Description'=>$_REQUEST['Commission_Description'],'LastEdited'=>date('Y-m-d H:i:s'));
...
$strWhere='ProgramsType ="Sponsor" ';
$CommissionRecords=$utilObj->getMultipleRow('CommissionProgram',$strWhere);
...
<img border="0" title="Edit Coaching Commission" src="../../images/icon_page_edit.png"> </a> &nbsp;<a  href="CommissionsSponsorprogramSetupPopup.php?Task=setup&comprogid=<?php echo $Commissioncval['ID'];?>"  class="Commissionsetup" > <img border="0" src="../../images/icon_settings.png" title="Setup Commission Level"></a>
...
?>
    <tr id="<?php echo $colors; ?>">
      <td  colspan="5">No Commission Program Found</td>
    </tr>
    <?php  } ?>
  </table>
</div>
